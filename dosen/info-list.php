                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $cari = $_POST['cari'];
                                $sql = "select * from infotugas where Nama_Dsn like '%$cari%' or Nama_Matkul like '%$cari%'";
...
//                            if (mysqli_num_rows($query) > 0) {
                                ...
                                while ($r = mysqli_fetch_array($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div id="thanks">
                                                <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Info" href="info-edit.php?Id_info=<?php echo $r['Id_info']; ?> ">
                                                    <span class="glyphicon glyphicon-edit"></span>
                                                </a>  
                                                <a onclick="return confirm('Yakin hapus <?php echo $r['Id_info']; ?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Info" href="info-hapus.php?Id_info=<?php echo $r['Id_info']; ?>">
