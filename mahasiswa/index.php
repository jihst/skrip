...
$nim = $_GET['nim'];
$sql = "SELECT * FROM mahasiswa left join users on users.Id_user = mahasiswa.Id_user where nim=$nim";
                    ...
                    <div class="container-fluid">
                        <div id="wrapper">
                            ...
                            <table class="table table-condensed">
                                <tbody>
                                    <tr>
                                        <td><label class="control-label col-sm-20">NIM</label></td>
                                        <td> : </td>
                                        <td><?php echo $nim; ?></td>
                                    </tr>
                                    <tr>
                                ...
                                <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Mahasiswa" href="passwordedit.php?nim=<?php echo $_SESSION['nim']; ?>">Edit Profil</a>
