...
$nim = $_GET['nim'];
$sql = "SELECT * FROM users left join mahasiswa on mahasiswa.Id_user = users.Id_user where nim=$nim";
                            ...
                            <table class="table table-condensed" style="width: 50%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> : </td>
                                        <td><input class="form-control" name="Nim" id="disabledInput" type="text" value="<?php echo $nim; ?>" readonly=""></td>
                                    </tr>
                                    <tr>
                                        <td>Username</td>
                                        <td> : </td>
