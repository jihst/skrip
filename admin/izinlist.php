        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div id="wrapper">
                    ...
                    <a href="izinjumlah.php" class="btn btn-default"><i ></i> Lihat Rekapan Data Izin </a>
                    <br><br/>
                    <div id="thanks">
                        <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Cetak Izin" href="izincetak.php?Id_izin=<?php echo $r['Id_izin']; ?> ">
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['submit'])) {
                                $nim = $cari = $_POST['cari'];
                                $sql = "SELECT * FROM perizinan left join mahasiswa on perizinan.NIM = mahasiswa.NIM left join matakuliah on perizinan.Kode_Matkul = matakuliah.Kode_Matkul where Nama_Mhs like '%$cari%' or Nama_Matkul like '%$cari%'";
                            } else {
                                $sql = "SELECT * FROM perizinan left join mahasiswa on perizinan.NIM = mahasiswa.NIM left join matakuliah on perizinan.Kode_Matkul = matakuliah.Kode_Matkul ";
                                                          }
                            ...
                            while ($r = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td> <img src="../gambar/<?php echo $r['Bukti_Izin']; ?>" width="200"/></td>
