...
<html lang="en">
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./dsnproses.php">
            <div id="wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ol class="breadcrumb">
                                    <li class="active">
                                        <i class="fa fa-edit"></i> Forms Tambah Data Dosen
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <form role="form">
                                    ...
                                    <div class="form-group">
                                        <label>NIDN :</label>
                                        <input class="form-control" name="nidn" placeholder="masukkan NIDN">
                                    </div>
                                    ...
                                    <button type="submit" name="dsntambah" class="btn btn-default">Tambah</button>
