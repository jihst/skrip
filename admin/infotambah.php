...
<html lang="en">
    ...
    <body>
        ...
        <form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./infoproses.php">
            <div id="wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <form role="form">
                                    ...
                                    <div class="form-group">
                                        <label>Tugas :</label>
                                        <input class="form-control" name="tugas" placeholder="Masukkan Tempat Lahir">
                                    </div>

                                    <div class="form-group">
                                        <label>Deadline :</label>
                                        <input class="form-control" name="deadline" placeholder="Masukkan Tanggal Lahir" value="<?php
                                        $tgl = date('Y-m-d');
                                        echo $tgl;
                                        ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" name="keterangan" placeholder="Masukkan Alamat Lengkap Mahasiswa"></textarea>
                                    </div>
