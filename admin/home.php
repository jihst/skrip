        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="add_user.php?page=add_user" class="active"><i class="fa fa-dashboard fa-fw"></i> Tambah User </a>
                    </li>
                    <li>
                        <a href="index.php?page=data" class="active"><i class="fa fa-dashboard fa-fw"></i> Data Dosen </a>
                    </li>				
                    <li>
                        <a href="index.php?page=izin" class="active"><i class="fa fa-dashboard fa-fw"></i> Data Mahasiswa </a>
                    </li>
					<li>
